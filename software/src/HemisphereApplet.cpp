...
float HemisphereApplet::InF(int ch, int max) {
...
// --- CV Output methods
void HemisphereApplet::Out(int ch, int value) {
...
void HemisphereApplet::GateOut(int ch, bool high) {
    ...
    // -------------------------------
void HemisphereApplet::gfxCursor(int x, int y, int w, int h, const char *str, const char *extra_str) {
  SetLabel(str);
  SetAux(false);
...
void HemisphereApplet::gfxSpicyCursor(int x, int y, int w, int h, const char *str, const char *extra_str) {
  SetLabel(str);
  SetAux(true);
  if (EditMode()) {
...
void HemisphereApplet::gfxEndCursor(bool selected, bool spicy, const char *str, const char *extra_str) {
  if (!selected) return;
...
void HemisphereApplet::gfxParamHeader() {
